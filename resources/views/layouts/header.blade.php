...
<head>
    ...
    <title>Adorn Beauty Salon</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/vendors/data-tables/extensions/responsive/css/responsive.dataTables.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('public/vendors/select2/select2-materialize.css')}}" type="text/css">
    ...
    <link rel="stylesheet" href="{{ asset('public/css/form_builder.css')}}"/>
            ...
            <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-purple-deep-orange gradient-shadow">
                <div class="nav-wrapper">
                    ...
                    <ul class="navbar-list right">
                        ...
                        {
                            $loc_name = DB::table('tbl_locations')->where('tbl_locations_id',Auth::user()->location_id)->select('tbl_locations_name','tbl_locations_id')->first();
                            session()->put('location_name',$loc_name->tbl_locations_name);
                        }
                        
                        ?>

                        <li><a class="waves-effect waves-block waves-light notification-button" href="javascript:void(0);" data-target="locations-dropdown"><i class="material-icons">location_on</i><b id="location_name">{{session()->get('location_name')}}</b></a></li>

                        <li class="hide-on-med-and-down"><a class="waves-effect waves-block waves-light  toggle-fullscreen" href="javascript:void(0);"><i class="material-icons">settings_overscan</i></a></li>

                        <li class="hide-on-large-only search-input-wrapper"><a class="waves-effect waves-block waves-light search-button" href="javascript:void(0);"><i class="material-icons">search</i></a></li>
                        <!-- <li><a class="waves-effect waves-block waves-light notification-button" href="javascript:void(0);" data-target="notifications-dropdown"><i class="material-icons">notifications_none<small class="notification-badge">5</small></i></a></li> -->
                        <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ asset('public/images/avatar/avatar-7.png') }}" alt="avatar"><i></i></span></a></li>
                    ...
                    <ul class="dropdown-content" id="locations-dropdown">
                        <?php
                        ...
                        $exp_location = explode(',',Auth::user()->location_id);
                        if (session()->get('location_id') == '') 
                        {
                            session()->put('location_id', $exp_location[0]);
                        }

                        
                        foreach ($exp_location as $key => $value) 
                        {
                            $locations_name = DB::table('tbl_locations')->where('tbl_locations_id',$value)->select('tbl_locations_name','tbl_locations_id')->first();
                            echo '<li class="dropdown-item" onclick="changelocation(this)" data-name="'.$locations_name->tbl_locations_name.'" data-id="'.$locations_name->tbl_locations_id.'" ><a class="grey-text text-darken-1" href="javascript:void(0);">'.$locations_name->tbl_locations_name.'</a></li>';
                            ?>
                        <?php }
                        /*if (session()->get('locations_name') == '') 
                        {
                            session()->put('locations_name',$locations_name->tbl_locations_name);
                        }*/
                        ?>    
                    </ul>
                   ...
                   <!--  <ul class="dropdown-content" id="notifications-dropdown">
                    ...
                    <ul class="dropdown-content" id="profile-dropdown">
                        ...
                        <li><a class="grey-text text-darken-1" href="{{ route('logout') }}"onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();"><i class="material-icons">keyboard_tab</i>{{ __('Logout') }}</a></li>

            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12 breadcrumbs-left">
                        <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Add Roles</span></h5>
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ route('admins') }}">Roles</a>
                            </li>
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <div class="col s12">
                                                <form class="row" method="POST" action="{{ route('RolesStore') }}">
                                                @csrf	
                                                    <div class="col s12">
                                                        
                                                        <div class="input-field col s6">
                                                            <input id="type" type="text" class="validate @error('type') is-invalid @enderror" name="type">

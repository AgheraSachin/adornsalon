            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12 breadcrumbs-left">
                        <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Add Staff</span></h5>
                            ...
                            <div id="input-fields" class="card card-tabs">
                                <div class="card-content">
                                    <div id="view-input-fields">
                                        <div class="row">
                                            <div class="col s12">
                                                <form class="row" method="POST" action="{{ route('StaffStore') }}" enctype="multipart/form-data">
                                                @csrf	
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="start_date" type="text" class="datepicker validate @error('start_date') is-invalid @enderror" name="start_date" required="">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="end_date" type="text" class="datepicker validate @error('end_date') is-invalid @enderror" name="end_date">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="break_time" type="text" class="timepicker validate @error('break_time') is-invalid @enderror" name="break_time" required="">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="salary" type="number" class="validate @error('salary') is-invalid @enderror" name="salary" step="any" required="">
                                                        ...
                                                        <div class="col s4" style="height: 90px;">
                                                            <div class="input-field">
                                                                <select class="select2 browser-default" multiple="multiple" id="default-select-multi" name="services[]" required="">
                                                                   <?php foreach ($services_types as $key => $value) { ?>
                                                                        <option value="{{$value->tbl_service_types_id}}">{{$value->tbl_service_types_types}}</option>
                                                                    <?php }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="col s4">
                                                            <input id="color_code" type="color" class="validate @error('color_code') is-invalid @enderror" name="color_code">
                                                        ...
                                                        <div class="col s4">
                                                            ...
                                                            <label>
                                                                <input class="with-gap validate @error('enable_online') is-invalid @enderror" type="radio" id="yes" name="enable_online" value="1" required="" /><span><label for="yes">Yes</label></span>
                                                            </label>
                                                            <label>
                                                                <input class="with-gap validate @error('enable_online') is-invalid @enderror" type="radio" id="no" name="enable_online" value="0" /><span><label for="no">No</label></span>
                                                            </label>
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="emergency_name" type="text" class="validate @error('emergency_name') is-invalid @enderror" name="emergency_name">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="emergency_contact" type="text" class="validate @error('emergency_contact') is-invalid @enderror" name="emergency_contact">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="emergency_relation" type="text" class="validate @error('emergency_relation') is-invalid @enderror" name="emergency_relation">
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="service_commission" type="number" class="validate @error('service_commission') is-invalid @enderror" name="service_commission" step="any">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="product_commission" type="number" class="validate @error('product_commission') is-invalid @enderror" name="product_commission" step="any">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <input id="voucher_commission" type="number" class="validate @error('voucher_commission') is-invalid @enderror" name="voucher_commission" step="any">

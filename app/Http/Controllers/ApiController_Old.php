...
class ApiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $servicetype = ServiceTypes::where('tbl_service_types_location_id',$request->location)->get();
            if($servicetype!='[]')
            {
        ...
        {
            $servicetype = ServiceTypes::join('tbl_services','tbl_services.tbl_services_type','tbl_service_types.tbl_service_types_id')->where('tbl_service_types_id',$request->service_type)->get();
        ...
        if ($modalname == 'appointment' && $apitype == 'store') 
        {
            ...
            else
            {
                ...
                $add_client = new Client([
                    ...
                    'tbl_clients_first_name' => $request->data['cname'],
            ...
            $imp_service = '';
            for ($i=0; $i < count($request->data['services']); $i++) { 
                $imp_service = implode(',',$request->data['services']);
            }
           ...
           // $app_date = date("Y-m-d",strtotime($request->data['date']));
            ...
            $new_aapointment = new Appointment([
                ...
                'tbl_appointment_noofperson' => $request->data['noofperson'],
        ...
        if ($modalname == 'client' && $apitype == 'register') 
        {
            ...
            else
            {
                ...
                $add_client = new Client([
                    ...
                    'tbl_clients_middle_name' => $request->data['middle_name'],
